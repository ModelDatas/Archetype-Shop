 ...
 * 
 */
@WebServiceClient(name = "WeatherInterfaceImplService", targetNamespace = "http://Impl.server.jaxws.webservice.com.cn/", wsdlLocation = "http://localhost:6789/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERINTERFACEIMPLSERVICE_QNAME = new QName("http://Impl.server.jaxws.webservice.com.cn/", "WeatherInterfaceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:6789/weather?wsdl");
    ...
    public WeatherInterfaceImpl getWeatherInterfaceImplPort() {
        return super.getPort(new QName("http://Impl.server.jaxws.webservice.com.cn/", "WeatherInterfaceImplPort"), WeatherInterfaceImpl.class);
    }
    ...
    public WeatherInterfaceImpl getWeatherInterfaceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Impl.server.jaxws.webservice.com.cn/", "WeatherInterfaceImplPort"), WeatherInterfaceImpl.class, features);
    }
