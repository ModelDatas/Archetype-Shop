 ...
 * generated in the cn.com.webservice.jaxws.server.impl package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://Impl.server.jaxws.webservice.com.cn/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://Impl.server.jaxws.webservice.com.cn/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.com.webservice.jaxws.server.impl
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Impl.server.jaxws.webservice.com.cn/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Impl.server.jaxws.webservice.com.cn/", name = "queryWeatherResponse")
